...
var UtilityClient = /** @class */ (function (_super) {
    __extends(UtilityClient, _super);
     ...
     */
    UtilityClient.prototype.getTime = function () {
     ...
     */
    UtilityClient.prototype.getHeight = function () {
        return __awaiter(this, void 0, void 0, function () {
            var uri;
            return __generator(this, function (_a) {
                uri = '/v4/height';
     ...
     */
    UtilityClient.prototype.screen = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var uri;
            return __generator(this, function (_a) {
                uri = '/v4/screen';
                return [2 /*return*/, this.get(uri, { address: address })];
            });
        });
    };
